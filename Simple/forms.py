...
class VigenereForm(forms.Form):
    ...
    cipher_key = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "SecretKey"}
        ),
    )
    ...
    def clean_cipher_key(self):
        ...
        if not data.isalpha():
            raise forms.ValidationError(
                "Cipher key must be One word with no "
...
class FizzBuzzForm(forms.Form):
    ...
    count_to = forms.IntegerField(
        ...
        min_value=10,
        max_value=1000,
        widget=forms.NumberInput(attrs={"class": "form-control", "value": "100"}),
    )
    ...
    var_1 = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Fizz", "value": "Fizz"}
        ),
    )
    ...
    var_1_multiple = forms.IntegerField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "3", "value": "3"}
        ),
    )
    ...
    def clean(self):
        ...
        if (var_2 and not var_2_multiple) or (var_2_multiple and not var_2):
            raise forms.ValidationError(
                "Must enter both second variable and " "its multiplier or neither.",
                code="var_2_error",
            )

        if (var_3 and not var_3_multiple) or (var_3_multiple and not var_3):
            raise forms.ValidationError(
                "Must enter both third variable and " "its multiplier or neither.",
                code="var_3_error",
            )
...
class ChangeForm(forms.Form):
    ...
    item_cost = forms.FloatField(
        ...
        max_value=2000,
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "57.45"}
        ),
    )
    ...
    amount_paid = forms.FloatField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "60.00"}
        ),
    )
